...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID of validate.
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Indicates wheather the user is an admin.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x17, 0x65, 0x70, 0x69, 0x66, 0x61, 0x6e, 0x74, 0x73, 0x65, 0x76, 0x2e, 0x73, 0x73, 0x6f,
